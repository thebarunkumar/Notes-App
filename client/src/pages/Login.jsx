...
const Login = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-lightGray p-4">
          ...
          <CardContent className="space-y-4">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                ...
                <Link
                  to={"/forgot-password"}
                  className="text-primaryBlue hover:underline relative text-sm"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <Button
                type="submit"
                className="w-full border border-gray-200 bg-primaryBlue hover:bg-blue-500 cursor-pointer relative"
                disabled={isLoading}
              >
                {isLoading ? (
                  <>
            ...
            <div className="text-center text-sm">
              ...
              <Link
                to="/signup"
                className="text-primaryBlue hover:underline font-medium relative"
              >
                Sign up
              </Link>
            </div>
